...
| FreeRDP 3.31.0 | `3.31.0.tar.gz` | Apache-2.0 | `FreeRDP-LICENSE` |
| CPU-features code distributed in the FreeRDP source | within `3.31.0.tar.gz` | see upstream notice | `FreeRDP-cpufeatures-NOTICE` |
